		...
		if (accountInformation != null) {
			...
			for (AccountInformation information : accountInformation) {
				AccountInformationDTO accountInformationDTO = new AccountInformationDTO(information.getId(),
						information.getAccountName(), information.getSubSchedule(), information.getSchedule(),
						information.getAddress1(), information.getAddress2(), information.getTown(),
						information.getPinDistrict(), information.getState(), information.getAreaName(),
						information.getPhone(), information.getMobile(), information.getEmail(),
						information.getShortName(), information.getLicNo1(), information.getLicNo2(),
						information.getLicExpiry(), information.getRetLicNo1(), information.getRetLicNo2(),
						information.getRetExpiry(), information.getFoodLicNo(), information.getOtherLicense(),
						information.getOtherLicenseExpiry(), information.getGstType(), information.getGstIN(),
						information.getNatureOfGST(), information.getUinNo(), information.getSaleType(),
						information.getCustomerType(), information.getCreditLimit(), information.getDueDays(),
						information.getContactPerson(), information.getHsnCode(), information.getSacCode(),
						information.getRateOfTax(), information.getOpeningBalance(), information.getOpeningType(),
						information.getSpecialRAemarks());
	...
	public AccountInformationDTO getaccountInformationById(Long id) {
		...
		if (accountInformation != null) {
			AccountInformationDTO accountInformationDTO = new AccountInformationDTO(accountInformation.getId(),
					accountInformation.getAccountName(), accountInformation.getSubSchedule(),
					accountInformation.getSchedule(), accountInformation.getAddress1(),
					accountInformation.getAddress2(), accountInformation.getTown(), accountInformation.getPinDistrict(),
					accountInformation.getState(), accountInformation.getAreaName(), accountInformation.getPhone(),
					accountInformation.getMobile(), accountInformation.getEmail(), accountInformation.getShortName(),
					accountInformation.getLicNo1(), accountInformation.getLicNo2(), accountInformation.getLicExpiry(),
					...
					accountInformation.getSpecialRAemarks());
